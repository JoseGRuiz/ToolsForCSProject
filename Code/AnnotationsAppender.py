...
def main(path_to_files, type_of_files, path_to_images):
	"""
	...
	if type_of_files == 'json':#merge json files
		...
		header, annotations = extract_useful(header, annotations, path_to_images)
...
if __name__ == '__main__':
	...
	main(parsed.path_to_files, parsed.type_of_files, parsed.path_to_images)
